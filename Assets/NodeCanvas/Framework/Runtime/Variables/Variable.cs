		...
		public override void InitializePropertyBinding(GameObject go, bool callSetter = false){
		    ...
		    if (prop != null){
			    ...
			    if (prop.CanRead){
			    	...
			    	getter = ()=> { Debug.LogError("You tried to Get a Property Bound Variable that has no get accessor!"); return default(T); };
			    }
			    ...
			    if (prop.CanWrite){
			    	...
			    	setter = (o)=> { Debug.LogError("You tried to Set a Property Bound Variable that has no set accessor!"); };
			    }
