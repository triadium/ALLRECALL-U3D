...
namespace NodeCanvas{
	...
	public class ActionListPlayer : MonoBehaviour, ITaskSystem, ISerializationCallbackReceiver {
		...
		[UnityEditor.MenuItem("Window/NodeCanvas/Create/Standalone ActionList")]
		static void Create(){
			var list = new GameObject("ActionList").AddComponent<ActionListPlayer>();
			UnityEditor.Selection.activeObject = list;
		}
